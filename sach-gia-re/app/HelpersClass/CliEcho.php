...
class CliEcho
{
    ...
    public static function enable_flush($enabled = null):bool
    {
...
//      $out = "\n" . "$out" . "\n";
    ...
    {
        return self::comment($message, 'info', false, $return);
    }

    public static function infonl($message, $return = false)
    {
        return self::comment($message, 'info', true, $return);
    }

    public static function success($message, $return = false)
    {
        return self::comment($message, 'success', false, $return);
    }

    public static function successnl($message, $return = false)
    {
        return self::comment($message, 'success', true, $return);
    }

    public static function warning($message, $return = false)
    {
        return self::comment($message, 'warning', false, $return);
    }

    public static function warningnl($message, $return = false)
    {
        return self::comment($message, 'warning', true, $return);
    }

    public static function error($message, $return = false)
    {
        return self::comment($message, 'error', false, $return);
    }

    public static function errornl($message, $return = false)
    {
        return self::comment($message, 'error', true, $return);
    }
